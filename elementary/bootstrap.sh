...
read USER_PROMPT
if [ "$USER_PROMPT" = 'y' ] || [ "$USER_PROMPT" = 'Y' ] || [ "$USER_PROMPT" = '' ]; then
    sudo apt -y install exfat-fuse gimp gparted transmission-gtk virtualbox xclip
else
...
read USER_PROMPT
if [ "$USER_PROMPT" = 'y' ] || [ "$USER_PROMPT" = 'Y' ] || [ "$USER_PROMPT" = '' ]; then
    . ${SCRIPT_DIR}/../../common/user-snaps.sh
else
...
read USER_PROMPT
if [ "$USER_PROMPT" = 'y' ] || [ "$USER_PROMPT" = 'Y' ] || [ "$USER_PROMPT" = '' ]; then
    . ${SCRIPT_DIR}../debian/google-chrome.sh
else
...
read USER_PROMPT
if [ "$USER_PROMPT" = 'y' ] || [ "$USER_PROMPT" = 'Y' ] || [ "$USER_PROMPT" = '' ]; then
    . ${SCRIPT_DIR}/development-tools.sh
else
